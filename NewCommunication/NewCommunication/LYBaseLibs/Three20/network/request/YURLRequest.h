 ...
 * @see timeoutInterval
 */
extern const NSTimeInterval YURLRequestUseQueueTimeout;

@protocol YURLRequestDelegate;
@protocol YURLResponse;
 ...
 */
@interface YURLRequest : NSObject {
    NSString*             _urlPath;
 ...
 */
@property (nonatomic, copy) NSString* URL __YDEPRECATED_METHOD;
 ...
 */
@property (nonatomic, retain) id<YURLResponse> response;
 ...
 */
@property (nonatomic) YURLRequestCachePolicy cachePolicy;
