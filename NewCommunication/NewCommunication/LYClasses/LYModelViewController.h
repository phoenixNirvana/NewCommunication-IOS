...
// Network
#import "YModelDelegate.h"
#import "LYViewController.h"

@protocol YModel;

@interface LYModelViewController : LYViewController<YModelDelegate>{
    id<YModel> _model;
    NSError*    _modelError;
    struct {
...
@property (nonatomic, retain) id<YModel> model;
